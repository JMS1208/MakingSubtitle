...
class SettingsFragment : Fragment() {
    ...
    private fun saveSettings() {
        ...
        //TODO 튜토리얼 설정
//        binding.swShowOptions.setOnCheckedChangeListener { _, isChecked ->
//            val value = if(isChecked) {
//                ShowOptions.SHOW_AGAIN.value
//            } else {
//                ShowOptions.DO_NOT_SHOW_AGAIN.value
//            }
//            viewModel.saveShowOptions(value)
//        }
...
//        lifecycleScope.launch {
//
//            val isChecked = when(viewModel.getShowOptions()) {
//                ShowOptions.SHOW_AGAIN.value-> true
//                else -> false
//            }
//
//            binding.swShowOptions.isChecked = isChecked
//
//        }
